...
| 漏报段（FN） | 7 | 9 | +2 |
| 误报次数（FP） | 31 | 52 | +21 |
| 召回率 recall | 87.50% | 83.93% | -0.0357 |
| 漏报率 miss_rate | 12.50% | 16.07% | +0.0357 |
| 精确率代理¹ | 61.25% | 47.47% | -0.1378 |
| 告警事件总数 | 486 | 508 | +22 |
...
|------|--------|-----------|-----------|-----------|-----------|-----------|-----------|
| 1-1-1 | 56 | 7 | 9 | 31 | 52 | 88% | 84% |

## 3. 单条记录明细

| 记录 | 机位 | 采集间隔→使用帧 | 标真段 | 漏报@手腕 | 漏报@延长 | 误报@手腕 | 误报@延长 |
|------|------|-----------------|--------|-----------|-----------|-----------|-----------|
| `clip_0013_start_00-11-22_rtmpose_m` | 1-1-1 | 1→4552/9103 | 54 | 7 | 9 | 29 | 50 |
| `clip_0025_start_00-43-15_rtmpose_m` | 1-1-1 | 1→102/204 | 2 | 0 | 0 | 2 | 2 |

## 5. 延长探针新增误报（相对手腕）

- `clip_0013_start_00-11-22_rtmpose_m`：误报 29 → 50
